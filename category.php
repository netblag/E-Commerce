              ...
              <div class="showcase">
                <div class="showcase-banner">
                  <img src="./admin/upload/<?php
                                                      ...
                                                      ?>" alt="کت چرم زمستانی مردانه" width="300" class="product-img default" />
                  <img src="./admin/upload/<?php
                                                      echo $row['product_img']
                                                      ?>" alt="کت چرم زمستانی مردانه" width="300" class="product-img hover" />
                  <!-- Applying coditions on dicount and sale tags  -->
                  <!--  -->
                  <?php
                  if ($new_product_counter == 1) {
                  ?>
                    <p class="showcase-badge">۱۵٪</p>
                  <?php
                  }
                  ?>
                  <!--  -->
                  ...
                  ?>
                    <p class="showcase-badge angle black">حراج</p>
                  <?php
                  }
                  ?>
