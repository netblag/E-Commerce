          ...
          <div class="product_detail_box">
            ...
            <div class="prouduct_information">
              <div class="product_description">
                <div class="product_title"><strong>نام:</strong></div>
              ...
              <div class="product_description">
                <div class="product_title"><strong>قیمت:</strong></div>
                <div class="product_detail">
                  <div class="price-box">
                    <p class="price"><?php echo $product_price; ?> تومان</p>
              ...
              <div class="product_description">
                <div class="product_title"><strong>امتیاز:</strong></div>
                <div class="product_detail">
            ...
            <div class="product_counter_box">
              ...
              <div class="buy-and-cart-btn">
                ...
                <button type="button" class="btn_but_product"> 
                  <a href="checkout.php" style="text-decoration:none; color:#FFFFFF">خرید</a>
                </button>
              </div>
            </div>
          </div>
